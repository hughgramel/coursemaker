...
const spec: LectureSpec = {
  ...
  followups: [
    ...
    "A referral from a friend who says “you should apply” is weaker than one where the friend submits your resume through the internal portal with a written endorsement. What is the difference from the hiring team’s perspective, and how do you ask for the stronger version without putting your friend in an uncomfortable position?",
