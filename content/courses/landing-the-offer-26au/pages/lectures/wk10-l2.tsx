...
const spec: LectureSpec = {
  ...
  followups: [
    ...
    "McKenzie (2012) writes: “Negotiating never makes worthwhile offers worse. This means you need a commitment strategy: you always, as a matter of policy, negotiate all offers.” Write the exact sentence you would say to a recruiter after receiving a verbal offer before you have all the numbers in writing.",
    "Graham (2023) describes consistency as the mechanism that compounds: “Writing a page a day...” Apply that framing to your job search after week 10. What is the minimum consistent action you will take each week until you sign an offer?",
