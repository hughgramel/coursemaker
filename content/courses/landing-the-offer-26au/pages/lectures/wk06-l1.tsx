...
const spec: LectureSpec = {
  ...
  topics: [
    ...
    "The order of operations: requirements → API design → data model → high-level diagram → deep dive",
  ...
  followups: [
    ...
    "Most candidates lose points in system design before drawing a single box (ByteByteGo, 2023). Describe the “order of operations” from this lecture. Which step do candidates most often skip, and what does skipping it cost them?",
    "A candidate is asked to design Twitter’s timeline feature. They immediately draw a database and an API server. What requirements questions should they have asked first? List at least four, and explain what design decision each answer would change.",
