...
const spec: LectureSpec = {
  ...
  followups: [
    ...
    "Graham (2023) writes: &ldquo;If you&rsquo;re excited about some possibility that everyone else ignores, and you have enough expertise to say precisely what they&rsquo;re all overlooking, that&rsquo;s as good a bet as you&rsquo;ll find.&rdquo; Name one company where you have that kind of specific, non-generic enthusiasm. What is your unconventional move there?",
