...
const spec: ProjectSpec = {
  ...
  goals: [
    ...
    "Deliver the “I have a competing offer” script in the role-play without breaking the positive tone",
    "Respond to the “this is our best offer” pushback with a specific counter that does not accept or reject",
  ...
  rubric: [
    ...
    },
    {
      ...
      points: 35,
      notes:
        "Candidate maintains positive tone throughout; competing offer is raised without anchoring prematurely; “best offer” pushback receives a specific counter rather than acceptance or rejection",
    },
    {
  ...
  hints: [
    ...
    "When the recruiter says “this is our best offer,” the correct response is not to believe them immediately and not to call them a liar. The correct response is to acknowledge the statement, reaffirm your enthusiasm, and ask one specific question: “Is there any flexibility on the equity component?”",
    "Qureshi (2016) recommends always having a reason for your requests that the recruiter can take back to their manager. “I have a competing offer at a higher base” is a reason. “I just think I deserve more” is not.",
  ],
};
