...
const spec: LectureSpec = {
  ...
  followups: [
    ...
    "The Figma auto-layout guide (Figma, 2023) covers resizing behaviors: Hug, Fill, Fixed, and Min/Max. For a card component inside a 3-column grid, what resizing behavior should the card&rsquo;s width use? What about the card&rsquo;s height? Explain your reasoning.",
    ...
    "The lecture distinguishes macro-grid (page-level structure) from micro-grid (component internals). Find a real product screen and identify at least two places where a component&rsquo;s internal spacing breaks the page-level grid. Is that break intentional or accidental? How would you tell the difference?",
