...
const spec: LectureSpec = {
  ...
  followups: [
    ...
    "Khamatov (Smashing Magazine, 2023) distinguishes color palettes (what colors exist) from color schemes (how colors are used). Write out your product&rsquo;s palette layer (primitive values: Slate 100 through 900, Blue 100 through 900) and its scheme layer (semantic assignments: surface-base, text-primary, accent-default). How many scheme tokens point to the same palette value?",
