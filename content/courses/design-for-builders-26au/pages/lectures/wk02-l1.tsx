...
const spec: LectureSpec = {
  ...
  topics: [
    ...
    "Proximity: using whitespace to say “these things are related”",
  ...
  followups: [
    ...
    "Malewicz (2022) calls alignment the hardest principle for beginners to respect because “it looks fine to me.” Pick a layout you have built or admired. Toggle grid overlay on. Is everything actually on the grid?",
