...
const spec: LectureSpec = {
  ...
  topics: [
    ...
    "Defending choices with vocabulary: how to answer “why that color?” or “why that typeface?” without flinching",
  ...
  followups: [
    ...
    "A reviewer says: “The hero feels a bit busy.” Write three different responses. The first treats this as a question about visual hierarchy. The second treats it as a question about spacing. The third treats it as a question about copy-to-image ratio. Which response do you think is most useful, and why?",
