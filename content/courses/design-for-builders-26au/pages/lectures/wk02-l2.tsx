...
const spec: LectureSpec = {
  title: "Gestalt: how the brain groups things you didn’t tell it to group",
  date: "Week 2, Lecture 2",
  week: 2,
  topics: [
    "Proximity grouping: distance is the cheapest signal of belonging",
    "Similarity grouping: shape, color, and size say “same category”",
  ...
  followups: [
    ...
    "Gordon (2020) uses Gestalt to explain why visual hierarchy emerges without explicit instruction. In your own product’s interface, find one place where the grouping the brain infers does not match the grouping the information structure intends.",
