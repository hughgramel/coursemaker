...
const spec: LectureSpec = {
  ...
  topics: [
    ...
    "The subhead as proof: one sentence that answers &ldquo;why you?&rdquo;",
  ...
  followups: [
    "Write three headline variants for your product. Variant A: outcome-focused (&ldquo;Ship a landing page your customers actually read&rdquo;). Variant B: problem-focused (&ldquo;Stop shipping landing pages that bounce&rdquo;). Variant C: audience-focused (&ldquo;For founders who can code but freeze in Figma&rdquo;). Which one do you find most compelling, and what does that tell you about your customer?",
    "Segall (2023) argues that the subhead should answer the headline&rsquo;s implicit question. Take one of your three headlines and write a subhead that completes the thought. Then test it: read the headline and subhead aloud to someone unfamiliar with your product. Can they describe back to you what the product does? If not, what was missing?",
    "Wathan &amp; Schoger argue that labels are a last resort: format and context should communicate meaning before you add a label. Apply this to your hero CTA. If your button currently says &ldquo;Get started&rdquo;, rewrite it using the specific action the user takes. What does a more specific label do to the button&rsquo;s visual weight?",
