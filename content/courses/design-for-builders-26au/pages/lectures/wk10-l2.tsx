...
const spec: LectureSpec = {
  ...
  followups: [
    "Open your Figma file and locate all the color variables you defined. For each collection (primitive and semantic), write out the equivalent CSS custom property name you would use in code. For example, a Figma variable named &ldquo;color/brand/500&rdquo; might become &ldquo;--color-brand-500&rdquo;. Check that your naming is consistent: no camelCase mixed with kebab-case, no orphaned variables with no semantic counterpart.",
