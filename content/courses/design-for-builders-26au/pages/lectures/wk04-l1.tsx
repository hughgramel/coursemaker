...
const spec: LectureSpec = {
  ...
  followups: [
    ...
    "Pick the brand color for a product you admire. Convert it to OKLCH using a browser devtools color picker or an online converter. What is its chroma value? What happens to the color’s vibrancy if you reduce chroma by 30% while keeping hue and lightness constant?",
