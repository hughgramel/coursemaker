...
const spec: ProjectSpec = {
  ...
  overview: [
    ...
    "The rule for this section is simple: every asset must have a documented license before it goes into your production file. &ldquo;I think it&rsquo;s free&rdquo; is not a license entry. You will keep a running log in a shared spreadsheet or Figma table and verify each asset before you use it.",
  ...
  goals: [
    ...
    "Produce a 1200&times;630px OG image that reads clearly in a link preview at full size and in a 240px thumbnail crop",
  ...
  instructions: [
    ...
    },
    {
      ...
      body: "Start from your brand mark (the single icon or letterform you designed in Week 8). Create four Figma frames: 16&times;16px, 32&times;32px, 180&times;180px (Apple touch icon), and 512&times;512px (PWA / app store icon). At 16px, the mark must be legible without detail: simplify it if needed. At 512px, it can carry texture and color. Export all four. The 180px version needs 20px of padding inside the safe zone (the platform adds a rounded corner mask on top). Add &ldquo;design-for-builders-26au/assets/icons&rdquo; as the font source in your log with license &ldquo;your own original work&rdquo;.",
    },
    {
      title: "OG image (20 min)",
      body: "Create a 1200&times;630px frame. Place your wordmark (top-left or centered), a one-sentence value proposition, and one supporting visual (a product screenshot, an illustration, or a simple geometric shape in your brand color). Keep all critical content inside an 80px margin on every side. The supporting visual should be on the right half of the frame or in the background so the text block sits clearly on one side. Export the frame at 1x (1200&times;630px exactly). Crop a copy to 240&times;240px and check that the product name is still readable. If it is not, simplify.",
    },
    {
      title: "App Store screenshots or marketing mockups (30 min)",
      body: "Build two screenshot frames at 1290&times;2796px (iPhone 6.7&ldquo;, the required primary size for iOS App Store). If your product is web-only, use a 1440&times;900px desktop mockup instead. Each frame has three layers: a background fill in your brand color or a neutral, a device frame (use a Community Figma resource or a simple wireframe outline), and a text overlay with one feature message in large type. The text overlay should be readable at 320px thumbnail width. The feature message should complete the sentence &ldquo;Now you can&mdash;&rdquo; in five words or fewer.",
    },
    {
    ...
    },
    {
      ...
      body: "Exchange your asset log with a partner. Your partner checks: is every row complete? Is the license type specific (not just &ldquo;free&rdquo;)? Is the source URL the actual license page, not a landing page? Flag any row that seems incomplete or uncertain. The person whose log is being reviewed cannot argue during the review. Write down the flags and check them after.",
    },
  ],
  deliverables: [
    ...
    "OG image at 1200&times;630px, exported at 1x, with thumbnail crop check documented",
  ...
  rubric: [
    {
      ...
      points: 25,
      notes:
        "Every asset has a row. License type is the actual license name (e.g. &ldquo;SIL OFL 1.1,&rdquo; &ldquo;ISC,&rdquo; &ldquo;Unsplash License,&rdquo; &ldquo;CC0&rdquo;), not &ldquo;free.&rdquo; Source URL goes to the license page, not the asset page. Commercial use and attribution columns are filled.",
    },
    {
  ...
  hints: [
    ...
    "Many &ldquo;free for commercial use&rdquo; photo sites have changed their terms. Always read the current license page for the site, not a blog post summarizing it. Licenses change. The page does not lie.",
    ...
    "If you are not building a mobile app, the &ldquo;App Store screenshot&rdquo; deliverable maps to a marketing mockup for your web product. Use a 1440&times;900px browser frame from the Figma Community. The design constraints (text overlay + device frame + feature message) are identical.",
  ],
  late:
