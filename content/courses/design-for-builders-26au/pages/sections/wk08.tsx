...
const spec: ProjectSpec = {
  ...
  instructions: [
    {
      ...
      body: "Create a new page in your existing course Figma file named &ldquo;WK08 Logo Studio&rdquo;. Set up four frames: one 1200x400px artboard labeled &ldquo;Wordmarks&rdquo;, one 64x64px frame labeled &ldquo;Favicon test&rdquo;, one 1200x630px frame labeled &ldquo;OG test&rdquo;, and one 800x400px frame labeled &ldquo;Silhouette test&rdquo;. You will use all four by the end of section.",
    },
    {
      title: "Draft three wordmarks (30 min)",
      body: "You have 30 minutes to produce three distinct wordmarks on the &ldquo;Wordmarks&rdquo; artboard. Constraints:",
      steps: [
        ...
        "Draft C: take either Draft A or B and add one modification to create visual interest: a ligature between two letters, a modified counter (the enclosed space in a letter like &lsquo;O&rsquo; or &lsquo;e&rsquo;), a weight contrast between the first letter and the rest, or a simple geometric form attached to or replacing one letterform.",
  ...
  rubric: [
    ...
    },
    {
      ...
      points: 25,
      notes:
        "Both test frames are present and populated. Written observations go beyond &ldquo;looks good&rdquo; or &ldquo;doesn&rsquo;t work&rdquo; to name what specifically passes or fails and why.",
    },
    {
      dimension: "Peer critique given and received",
      points: 20,
      notes:
        "Critique uses specific vocabulary from lecture: silhouette, negative space, voice, legibility. Does not say &ldquo;I like it&rdquo; without a named reason.",
    },
    {
  ...
  hints: [
    ...
    "For Draft C, the &ldquo;one modification&rdquo; rule is strict. One change to one letterform or one relationship between two letterforms. Two modifications usually make the logo look effortful rather than considered.",
