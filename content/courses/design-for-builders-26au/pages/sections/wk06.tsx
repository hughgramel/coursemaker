...
const spec: ProjectSpec = {
  ...
  overview: [
    ...
    "The goal is to move from passive observation to active diagnosis. Any founder can say a landing page &ldquo;looks off.&rdquo; After this section you can name what is off, explain why it fails to convert, and demonstrate the fix in Figma.",
  ],
  goals: [
    ...
    "Rebuild a hero section in Figma that corrects the diagnosed failures while preserving the product&rsquo;s core message",
  ...
  instructions: [
    ...
    },
    {
      ...
      steps: [
        ...
        "Subhead: does it answer &ldquo;why you?&rdquo; in one sentence? Score 1-3.",
    ...
    },
    {
      ...
      steps: [
        ...
        "Preserve the product&rsquo;s actual headline and subhead copy. Fix the hierarchy, not the words.",
    ...
    },
    {
      ...
      body: "Compare your five-point scores against your partner&rsquo;s independent scores for the same hero. For any dimension where you scored differently, spend 60 seconds each defending your score. The goal is not consensus, it is understanding what specific evidence leads to different diagnoses.",
    },
    {
  ...
  rubric: [
    {
      ...
      points: 30,
      notes:
        "Each of the five dimensions scored for each hero, with one sentence of evidence. Evidence must name a specific element (not &ldquo;it looks cluttered&rdquo; but &ldquo;the headline and subhead are the same size, so the eye has no signal about which to read first&rdquo;).",
    },
    {
    ...
    },
    {
      ...
      points: 20,
      notes:
        "Evidence of written notes for two peers. Each note names one thing that works and one thing lost. Generic praise (&ldquo;looks clean&rdquo;) does not count.",
    },
    {
  ...
  hints: [
    "The most common critique failure is vagueness. &ldquo;The CTA is weak&rdquo; is not a critique. &ldquo;The CTA button uses a neutral gray that has lower visual weight than the hero image, so the eye never lands on it&rdquo; is a critique.",
