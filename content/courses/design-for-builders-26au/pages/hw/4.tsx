...
const spec: ProjectSpec = {
  ...
  overview: [
    "Every decision you have made in weeks 1 through 8 leaves a residue: your component naming conventions, your type scale, your color tokens, your landing page copy tone. This assignment collects that residue into a single artifact. A brand sheet is a one-page Figma document (A3 or 1600×2400 px) that answers the four questions any new collaborator asks the moment they sit down to work on your product: what does the name look like, what colors and type govern the product, and how does the product speak to people?",
  ...
  goals: [
    "Distill your product’s identity into a wordmark that is legible at 32 px and readable at billboard scale.",
  ...
  instructions: [
    {
      title: "Draft 3-5 wordmark options",
      ...
      steps: [
        ...
        "Export each candidate at three sizes: 32 px, 200 px, and 1200 px wide. Pin them to a comparison canvas in your Figma file.",
      ],
    },
    {
      title: "Run a peer critique and pick one direction",
      body: "Share the comparison canvas with at least two peers before Week 9. Collect one specific observation from each person: not “I like this one” but “the geometric sans reads as more technical because the counters are open.” Use the feedback to eliminate options and commit to one wordmark direction.",
      steps: [
    ...
    },
    {
      ...
      body: "Export the chosen wordmark at 32×32 px and examine it at 100% zoom. If individual letters are indistinct, you need either a simplified version (usually the first letter or a custom mark) or a heavier weight. Then export at 1200 px wide and check stroke contrast, spacing, and optical weight.",
      steps: [
        "If the full wordmark fails at 32 px, design a favicon-specific version: a single character, a monogram, or a minimal mark. This becomes your icon-only lockup.",
    ...
    },
    {
      ...
      steps: [
        "Show each color as a filled swatch (at least 80×80 px), its hex value, and its semantic name (primary, surface, text, text-subdued, error). Do not use descriptive names like “bright blue.”",
    ...
    },
    {
      ...
      steps: [
        ...
        "Show a body example at the size it appears in UI: a 3-4 sentence paragraph.",
    ...
    {
      title: "Add three do/don’t pairs for logo usage",
      body: "A do/don’t pair shows a correct usage and a specific incorrect usage side by side, with a one-line rule. Common violations: placing the wordmark on a low-contrast background, stretching or distorting the lockup, setting the wordmark in a different typeface, using the full wordmark where only the icon-only lockup fits.",
      steps: [
        "Each pair must show the actual wordmark in the incorrect state, not an abstract illustration. If the rule is “do not place on a background below 4.5:1 contrast,” show the wordmark on exactly that background.",
        "Label the do side in green and the don’t side in red. Use the semantic color tokens you defined in step 5.",
      ],
    },
  ],
  deliverables: [
    "Figma share link to the brand sheet (view access, anyone with the link). The frame must be A3 (297×420 mm) or 1600×2400 px.",
  ...
  rubric: [
    ...
    { dimension: "Do/don’t pairs show the actual violation", points: 10, notes: "Each pair renders the wordmark in the incorrect state. Abstract labels without a rendered example score 0." },
  ...
  hints: [
    "A competition canvas is worth making before you open your own file: collect the wordmarks of five products you admire (or compete with) and pin them side by side. Notice which ones you can read at a glance at 40 px. Notice which ones feel distinct from each other. Your wordmark needs to be legible in that company.",
    ...
    "Semantic color naming matters more than it seems. “Primary” tells a developer which token to use for a call-to-action button. “Blue-500” does not. When you name a token, ask: what is its job in the UI, not what does it look like.",
    "WCAG AA contrast for body text is 4.5:1. For large text (18 pt or 14 pt bold) it is 3:1. The Figma plugin Contrast (by Able) will check this in one click. Run it on every text-on-background pairing on your sheet.",
    "The writeup is graded for specificity, not length. “I chose Satoshi because its geometric construction felt modern” is a weak defense. “I chose Satoshi because its open apertures held up at 32 px where DM Sans condensed to illegibility, and the peer critique confirmed that both reviewers read it as technical without being cold” is a defense.",
  ],
