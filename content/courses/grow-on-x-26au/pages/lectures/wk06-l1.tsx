...
const spec: LectureSpec = {
  ...
  week: 6,
  topics: [
    "Three growth phases and what defines each: 0→1k (proving the niche), 1k→5k (compounding distribution), 5k→10k (network leverage)",
  ...
  followups: [
    "Welsh (2023) describes five solopreneur phases: Survival, Systems, Growth, Defense, Automation. Map those five onto the three growth phases from lecture (0→1k, 1k→5k, 5k→10k). Where do the maps align and where do they differ?",
    ...
    "The lecture identifies three distinct “stall points.” Choose one and write a specific 30-day plan to break through it. Your plan must name the metrics you will watch and the threshold at which you will change tactics.",
    "At 0→1k, borrowed distribution (replies, collaborations) matters more than original reach. At 5k→10k, your own distribution begins to carry weight. What is the transition point, and how would a creator know they’ve crossed it?",
