...
const spec: ProjectSpec = {
  ...
  background: [
    "The daily routine from lecture: 15 minutes writing or scheduling one post, 30 minutes replying with genuine added value, 15 minutes reviewing last week&rsquo;s metrics and noting what to adjust. This totals 60 minutes and is designed to fit around work or school hours.",
  ...
  instructions: [
    ...
    },
    {
      ...
      body: "The monthly retrospective is a 30-minute review: what worked, what flopped, what you will change. Put it on your calendar for the last Saturday or Sunday of each month. Write the specific date for this month&rsquo;s slot. The retrospective is the only place where you revise your strategy rather than just executing it.",
    },
    {
      title: "Identify one creator network to join or build",
      body: "A creator network is a small group of accounts in adjacent niches who amplify each other&rsquo;s work with genuine engagement, not reciprocal like-swaps. Identify one such group that already exists in your space, or name three creators you would invite to start one. Write the first action you will take this week: a direct message, a reply in public, or an introduction.",
    },
    {
  ...
  deliverables: [
    ...
    "A batching plan: day, time, duration, and expected output for this week&rsquo;s session",
  ...
  hints: [
    ...
    "A creator network is not a follow-for-follow agreement. It is a group of people who read each other&rsquo;s work closely enough to add genuine context in replies and quote posts. Start small: three people is enough.",
    "If you find that the 60-minute daily routine is not fitting, do not abandon it on the days when it won&rsquo;t fit. Cut 15-minute slices. A 15-minute reply session on a busy day keeps the habit alive.",
  ],
};
