...
const spec: ProjectSpec = {
  ...
  dueDate: "Week 5",
  overview: [
    "The system you designed in Section 4 only works if you run it. This assignment is not about designing a better calendar or debating which template fits you best &mdash; you chose one at the end of Week 4. For the next fourteen days you execute it: post, reply, batch, and touch at least one collaborator per week. The daily log you keep is the raw data of your practice. The weekly summaries are your first attempt to read that data honestly. Both are required because without the log, the summary is a story; without the summary, the log is noise.",
    "Growth on X is not a publishing problem. It is an operating problem. Most creators who plateau are not out of ideas; they are inconsistent. Consistency is not a personality trait; it is an output of a system run reliably. By the end of these two weeks you will know whether the system you chose fits your life as it actually is or as you imagined it would be. That finding is as valuable as any follower count you accumulate, because it tells you what to adjust before Week 5&rsquo;s retrospective.",
  ],
  goals: [
  ...
  instructions: [
    {
      ...
      steps: [
        "Hub-and-spoke (Welsh-style): one newsletter or longform anchor per week, 10&ndash;15 short posts derived from it across the week.",
    ...
    },
    {
      ...
      body: "Each day: 15 minutes writing and posting, 30 minutes replying to at least 10 accounts that are 10&ndash;100 times your size in the same niche, 15 minutes reviewing what you shipped and logging the numbers. Log your start time and end time. If you go over 60 minutes on a given day, note it &mdash; overruns are a signal that a part of the routine is under-scoped. The reply targets must be substantive: add a perspective, give a concrete example, or ask a specific question. &ldquo;Great post!&rdquo; does not count.",
    },
    {
      title: "Do one batching block per week",
      body: "Once per week, set a 90-minute timer and write 7&ndash;10 posts for the coming week. Schedule them in advance or save them as drafts. The block must be uninterrupted, per Graham&rsquo;s Maker&rsquo;s Schedule principle: no meetings on either side, no switching tasks partway through. Submit the drafts or scheduled-post screenshots as your batching artifact. The artifact must predate the posts going live &mdash; retroactive documentation is not accepted.",
    },
    {
      ...
      steps: [
        ...
        "DM a creator who is 5&ndash;20 times your size with a specific, genuine message referencing one piece of their work.",
  ...
  hints: [
    ...
    "Batching works because it separates creation from distribution. Welsh&rsquo;s system, as Basilio (2023) documents, produces 10&ndash;15 posts from a single hub piece per week. Draft into a queue; do not post live during the batch block.",
    ...
    "If your replies feel performative, you picked the wrong targets. Re-pick: same niche, roughly 10&ndash;100 times your size, posting content you would read anyway.",
    "Koe (2022) structures the daily block as creation first, then engagement, then review. Do not reverse the order &mdash; starting with replies pulls you into reactive mode before you have shipped anything of your own.",
