...
const spec: ProjectSpec = {
  ...
  background: [
    "Justin Welsh’s niche framework argues that the right niche sits at the intersection of what you know, what you’ve done, and who you want to serve, not just a topic you find interesting. Daniel Koe extends this by pointing out that a niche is not a content category but a transformation: you help a specific person move from a specific problem to a specific outcome. When you write “I write about productivity,” you are naming a topic. When you write “I help early-career engineers ship faster without burning out,” you are naming a transformation, and giving a potential follower a reason to care.",
  ...
  instructions: [
    {
      ...
      body: "Read Justin Welsh’s three-step niche framework (https://www.justinwelsh.me/newsletter/the-counterintuitive-approach-to-uncovering-your-profitable-niche) before you start. Then answer the three questions below in writing. Your answers will feed directly into your ideal-reader profile and bio draft. A niche that names only a topic, “finance” or “AI”, is not a niche; it is a section of a bookstore. Narrow until a specific person can read your niche statement and say “that’s me.”",
      steps: [
        "What transformation do you offer? Complete the sentence: “I help [specific person] go from [problem] to [outcome].”",
        ...
        "Who is your ideal reader? Write 3-5 bullets: what they do, what they want, what they fear, what they have already tried, and why it hasn’t worked.",
      ],
    },
    {
      ...
      steps: [
        ...
        "Proof (number, link, credential): Is there one fact, not an adjective, that backs up the promise? “Passionate about growth” is not proof. “Grew a newsletter to 12,000” is.",
    ...
    },
    {
      ...
      body: "Write three bio drafts, each under 160 characters. The three should differ in approach, not just wording: one might lead with proof, one with the transformation, one with the ideal reader named directly. Read each aloud. Ask whether a person who has never heard of you would understand it and feel something. Daniel Koe’s test: does the bio make your ideal reader feel seen, or does it make you feel described? Those are different goals and only one converts. After drafting all three, choose one and write a short paragraph (3-5 sentences) explaining why it is stronger than the others, not just that you like it better, but what specific conversion weakness in the other two made you rule them out.",
    },
    {
      title: "Refresh profile photo, header, and pinned post to match",
      body: "The bio you picked makes a claim. Your photo, header image, and pinned post either reinforce that claim or contradict it. A bio that promises tactical SaaS pricing advice paired with a landscape header and a pinned post about your marathon finish sends mixed signals to the visitor deciding whether to follow. Update all three so they tell the same story. The pinned post should answer “why follow this account” more directly than the bio does, it has room for a full sentence or two. Use it. Then take a screenshot of the live profile showing all four elements together.",
    },
  ],
  deliverables: [
    "Submit a single document with: (a) your one-sentence niche statement, (b) your ideal-reader profile (3-5 bullets), (c) all three bio variants, (d) which one you chose and why, (e) a before/after screenshot of your live X profile.",
  ...
  hints: [
    "If you can describe your niche only by listing your job title, narrow it further. “SaaS founder” is too broad; “SaaS founder writing about pricing experiments for B2B” is workable.",
    "Read Justin Welsh’s three-step niche framework (https://www.justinwelsh.me/newsletter/the-counterintuitive-approach-to-uncovering-your-profitable-niche) before drafting.",
    "Your bio is read by people who don’t know you yet. Don’t write for friends.",
    ...
    "The pinned post should answer ’why follow this account’ more directly than the bio does.",
    "The follower funnel from Week 1 runs: impression to profile click to follow. The bio only does one job, convert the profile click. Don’t load it with work it cannot do.",
  ],
