...
const spec: ProjectSpec = {
  ...
  goals: [
    ...
    "Identify which monetization path (newsletter, paid product, sponsorship, community) best fits your audience’s current trust state.",
    "Surface the single highest-risk assumption in your playbook and name the metric that will tell you if it is wrong.",
  ],
  background: [
    "Welsh (2023) maps creator growth across five phases, each with a different primary constraint: phase 1 (0-1k) is a discovery problem, phase 2 (1k-10k) is a trust problem, and phases 3 through 5 are leverage problems. Most learners in this course are in phase 1 or early phase 2, which means the bottleneck is reaching new people consistently, not monetizing the ones already there. Barry (2019, 2023) describes a flywheel in which audience borrowing from larger accounts compounds over time: a reply that surfaces in a large account’s thread reaches an audience that already trusts the context, converting at higher rates than cold discovery. Jin (2020) reframes the target from “10,000 followers” to “100 true fans”: a small group of highly engaged readers who buy everything you make is more durable than a large group that follows passively. Clouse’s trust battery (2023) operationalizes this: every follower arrives with a low-charge battery, and each piece of original, useful work charges it a small amount; each self-promotional post drains it. A monetization decision that requires high trust from a low-charge battery will fail regardless of audience size. Newton’s retrospective on Platformer (2025) provides the long-run evidence: subscriber loyalty at scale was earned by original reporting no one else was doing, not by audience size accumulated.",
  ],
  instructions: [
    {
      title: "Set your phased milestones (0→1k, 1k→5k, 5k→10k)",
      body: "Before you pick numbers, re-read Welsh (2023) on phase 1 timelines. Most learners overshoot by 2× or more because they assume growth is linear. It is not: early growth is slow, then it compounds once the trust battery across a small audience is charged enough to produce organic referrals.",
      steps: [
    ...
    },
    {
      ...
      body: "From Welsh’s 5 phases (2023), Barry’s ladders (2019), Jin’s 100 fans (2020), and Clouse’s trust battery (2023): choose one monetization path that fits where your audience is now, not where you hope it will be at 10k. State the first product or offer you would ship and the minimum trust-battery charge you think it requires.",
      steps: [
        "Newsletter: low barrier, builds direct relationship, works at 500-1k followers if the list converts. First product: a paid issue or a low-price PDF.",
    ...
    },
    {
      ...
      body: "Name one assumption your playbook depends on that could be wrong. Not “I might not stay consistent” (that is a discipline issue, not a strategic assumption). The assumption should be specific to your strategy: a claim about your audience’s behavior, your niche’s growth ceiling, or your format’s performance. Then state the metric that would tell you the assumption is wrong, and describe what you would do instead.",
    },
  ],
  deliverables: [
    "90-day playbook document (4-6 pages or equivalent slides). Five sections: phased targets, weekly system, first 30 days of posts (with the four-field format for each), monetization path with justification, and highest-risk assumption with contingency.",
  ...
  rubric: [
    ...
    { dimension: "Monetization choice justified", points: 15, notes: "Tied to specific sources and your audience’s current trust state, not future aspirations." },
    { dimension: "Highest-risk assumption named honestly", points: 10, notes: "Not “I might not stay consistent.” Specific to your strategy, with a named metric and a contingency." },
  ...
  hints: [
    "Re-read Welsh (2023) on the 5 phases before setting targets. The phase 1 timeline for most accounts starting under 200 followers is 3-6 months to 1k, not weeks. Set the number your data supports.",
    ...
    "Optional: Welsh’s “8M Business with 0 Employees” (~43 min, https://www.youtube.com/watch?v=ZkwYxYfkfYU) covers the full monetization ladder from first newsletter issue to paid product. Barry’s “Becoming a Billion-Dollar Creator” (~50 min, https://www.youtube.com/watch?v=v-xAQXohY5I) details the flywheel mechanics for audience borrowing at scale. Watch both before finalizing your monetization section.",
  ],
