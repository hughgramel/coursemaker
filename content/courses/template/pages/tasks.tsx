...
const weeks: WeekData[] = [
  {
    n: 1,
    theme: "Foundations (sample)",
    lectures: [
      { n: 1, title: "how lecture pages are structured" },
    ],
    sectionTitle: "read this template end to end",
    milestones: [
      "Skim every nav entry in the sidebar",
      "Identify the four index pages and where they live on disk",
    ],
